  ...
  return (
    <div  name ='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='flex flex-col max-w-[1000px] h-full mx-auto px-8 justify-center '>
            ...
            <h1 className='text-5xl sm:text-7xl font-bold text-[#ccd6f6] mb-4'>Haripriya Chittari</h1>
            <h2 className='text-2xl sm:text-5xl font-bold text-[#8892b8] mb-2'>I'm a Full Stack Developer.</h2>
