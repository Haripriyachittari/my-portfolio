    ...
    >
      <div className="max-w-[1000px]  mx-auto p-4 w-full flex flex-col justify-center h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            {/* Hovereffect */}
            <div className="opacity-0 group-hover:opacity-100 text-center content-div object-cover rounded-md">
              ...
              <div className="pt-2 text-center">
                <a
                  href="https://cryptozen-rt.netlify.app"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://github.com/Haripriyachittari/Cryptozen"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center border border-pink-600 text-pink-600 rounded-xl px-4 hover:bg-pink-600 hover:text-gray-300 py-2 m-2 font-bold text-lg">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 text-center content-div rounded-md">
              ...
              <div className="pt-2 text-center">
                <a
                  href="https://movie-box-xd.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://github.com/Haripriyachittari/Movie-box"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center  border border-pink-600 text-pink-600 rounded-xl hover:text-gray-300 hover:bg-pink-600  px-4 py-2 m-2 font-bold text-lg">
          ...
          <div
            style={{ backgroundImage: `url(${sneakerpp})` }}
            data-aos="fade-up"
            data-aos-delay="300"
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 text-center content-div rounded-md">
              ...
              <div className="pt-2 text-center">
                <a
                  href="https://ecommerce-productpage01.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center border border-pink-600 text-pink-600 rounded-xl hover:bg-pink-600  hover:text-gray-300 px-4 py-2 m-2 font-bold text-lg">
                ...
                <a
                  href="https://github.com/Haripriyachittari/Ecommerce-Product-Page"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center border border-pink-600 text-pink-600 rounded-xl hover:bg-pink-600  hover:text-gray-300 px-4 py-2 m-2 font-bold text-lg">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 text-center content-div rounded-md">
              ...
              <div className="pt-2 text-center">
                <a
                  href="https://quote-a-day.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center border border-pink-600 text-pink-600 rounded-xl  hover:text-gray-300 hover:bg-pink-600 px-4 py-2 m-2 font-bold text-lg">
                ...
                <a
                  href="https://github.com/Haripriyachittari/Quote-Generator-App"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center border border-pink-600 text-pink-600 rounded-xl hover:text-gray-300 hover:bg-pink-600  px-4 py-2 m-2 font-bold text-lg">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 text-center content-div rounded-md">
              ...
              <div className="pt-2 text-center">
                <a
                  href="https://weather-genie.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center border border-pink-600 text-pink-600 rounded-xl  hover:bg-pink-600  hover:text-gray-300 px-4 py-2 m-2 font-bold text-lg">
                ...
                <a
                  href="https://github.com/Haripriyachittari/Weather-App"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className="text-center border border-pink-600 text-pink-600   rounded-xl  hover:bg-pink-600  hover:text-gray-300  px-4 py-2 m-2 font-bold text-lg">
